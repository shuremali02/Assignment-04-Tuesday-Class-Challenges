...
JOKE: str = "\nHere is a joke for you! CTO: Why did the frontend developer break up with the backend developer? Dev: No communication. CTO: What? Dev: The backend never sent a response."
MESSAGE:str ="Sorry I only tell jokes."
def main():
